...
- 2026-09-23: README rewritten as a short front page: logo, badges, the network board as the hero, a Mermaid graph of the two gangs and the go-between, the betweenness chart, a Mermaid pipeline, a screen gallery and the run steps. The long sections moved to docs/design.md (design decisions and alternatives), docs/demo.md (the demo case and presentation script) and docs/new-investigation.md (new case and Neo4j); screenshots live in docs/assets and were taken at 1440 by 900 against the live seed.
